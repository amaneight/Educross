...
Public Class fc_hp
    ...
    Public Sub fc_hp_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'EducrossDataSet2.cr_db' table. You can move, or remove it, as needed.
        Me.Cr_dbTableAdapter.Fill(Me.EducrossDataSet2.cr_db)
        'TODO: This line of code loads data into the 'EducrossDataSet3.question' table. You can move, or remove it, as needed.
        Me.QuestionTableAdapter.Fill(Me.EducrossDataSet3.question)
        ...
        cmd = New SqlCommand("select * from facultyreg where facid='" + faclog.flog_user.Text + "' and password='" + faclog.flog_pass.Text + "' ", myconn)
        ...
        While dr.Read()
            ...
            fname.Text = "Welcome, Prof." & fn & " " & mn & " " & ln
            fdept.Text = dr("dept").ToString & " Department"
        ...
        cmd2 = New SqlCommand("SELECT COUNT(*) FROM cr_db where facid='" + faclog.flog_user.Text + "' ", myconn)
        crcnt = Convert.ToString(cmd2.ExecuteScalar)
        fccnt.Text = crcnt.ToString
    ...
    Private Sub createcr_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles createcr.Click
        crno = 1000
        ...
        cmd1 = New SqlCommand("select * from cr_db where crno='" + crno.ToString + "' ", myconn)
        dr = cmd1.ExecuteReader()

        If dr.HasRows() = True Then
            MsgBox("Crossword exists for selected subject", MsgBoxStyle.Information, "EDU.CROSS")
            ComboBox1.Text = ""
            ComboBox2.Text = ""
            ComboBox3.Text = ""
            dr.Close()
        Else
            dr.Close()
            'in_str = "insert into cr_db(crno,dept,year,sub,topic,facid) values ('" + crno.ToString + "','" + "IT" + "','" + ComboBox1.Text.ToString + "','" + ComboBox2.Text.ToString + "','" + ComboBox3.Text.ToString + "','" + faclog.flog_user.Text + "');"
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        If faclog.fl.Text = "flag" Then
            faclog.fl.Text = "fl"
        ElseIf faclog.fl.Text = "fl" Then
            facreg.facreg_Load(sender, e)
        End If
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If faclog.fl2.Text = "flag1" Then
            faclog.fl2.Text = "fl"
        ElseIf faclog.fl2.Text = "fl" Then

            crcross.crcross_Load(sender, e)
        End If
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        If faclog.fl4.Text = "flag1" Then
            faclog.fl4.Text = "flag1"
        ElseIf faclog.fl4.Text = "fl" Then
            stats.stats_Load(sender, e)
        End If
        stats.Show()
